...
registration、单调 snapshot chain、脱敏 ingest event 和 crash-safe exporter retry state；第二笔 connector
dashboard projection 尚未完成。当前仍只执行仓库内 recorded fixtures，没有网络、凭据或真实数据源；
