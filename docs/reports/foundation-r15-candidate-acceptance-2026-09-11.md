...
## R15b installed; sustained health and product checks separate

Deployment completed 23:09:39.965599–23:12:16.242846 UTC, exit 0. Receipt SHA `0626a1cf42e4cdf2ed6b2bf2ddda8a4b33485f5fc92b7b3052383f14e084a9ec`; installed verification SHA `ce2133d49dc74841faf70124d616d5bcf0737ce770b2a41154c9957c33578a03`. The 606 runtime files and 17 model configurations match the accepted packet; service/OpenClaw/source/mission authority is preserved. Controller PID 75609 started at 23:10:34.865832 UTC. Same-process 45-sample health observation is running; finalization/publication await its result.

Exact-bound read-only product audit at 23:12:53 UTC found one normal new planner Work refused by the daily budget before provider I/O. The two tracked DXC/EPAM directed admissions remain valid waits until `2026-09-12T00:00:00Z`, each with prior exact atomic budget-refusal/no-send proof. No fresh provider response, settled paid send, outcome, promotion, spec or model is claimed. One separate unproved-send barrier remains explicitly reported. Receipt SHA `88c7ce83cb52bd4ec7b627a105131f60ab711fe83ab12a937831a78b7c907d9b`; audit SHA `c4b58ba6ea5e5baaae7fdafe7272834eb8f45124ad34ec56db50809847da5b4a`; report SHA `01a5c1886056622ef17d5cd3e7ad8607a0b8f83874b705e275a89b1a22a44044`. Evidence copied to packet `product-audit-v1`. Follow up after UTC reset through normal scheduling; do not alter the signed budget or manufacture new admissions.


## Failed first health observation and disk recovery

The first 45-sample R15b health observation failed: samples 37–44 had stale heartbeat, then the controller restarted. Health summary SHA `5285882bb9dddcc30b718bda4561742e3ab9936f94ba205ff36fa94290a43a3f`. Controller/writer logs contain `OSError: [Errno 28] No space left on device` for heartbeat and hold writes. The parallel R16 copy rehearsal exhausted disk; this operating error invalidates continuous-runtime acceptance and is not hidden by the earlier passing samples. No verified release pointer was published.

Failed R16 scratch cleanup removed 13 partial database files / 1,142,845,440 bytes after metadata/hash/no-handle checks; receipt SHA `3e371efc1ef2a448e346edd13c013d9508f30004bf8d5275fa3c8c966f7f9eac`. Root then reverified all 15 database and 15 restored files in each of the latest three deployment snapshots (R14b, R14c1, first R15b) against each manifest. Obsolete R13c/R14a deployment rollback directories were removed: 27,882 files / 5,517,748,590 bytes. Receipt SHA `340e6294dff05df1d9ca10c1e5072e44415cf6959592056dd375188de19a5e79`. Original release acceptance/log evidence remains outside those backup directories. No archive was made.

Read-only `PRAGMA quick_check` passed for live Core, Scheduler, Router and dashboard projection. Same accepted R15b packet reinstalled 23:27:16.109134–23:28:34.838712 UTC, exit 0; installed verification remains `ce2133d49dc74841faf70124d616d5bcf0737ce770b2a41154c9957c33578a03`. A fresh recovery receipt and rollback snapshot preserve the distinction from the failed first run. New health output is `health-observation-recovery-v2`; finalization/publication await its complete result. A configurable scratch-space guard now has 124 passing local tests and awaits independent review before any further large rehearsal.


## Guarded successor and retained headroom

Root's scratch-space guard is committed as `77cdfb486896fafb269e078dd00c07d7df0545ee`. It exposes a positive configurable reserve (`--scratch-reserve-bytes` / `DALTON_REHEARSAL_RESERVE_BYTES`, default 4 GiB), measures the scratch filesystem, admits twice the full copy-plan estimate including WAL, checks each file and SQLite 32-page copy chunk, and treats space failure as fatal between all steps. Local 124 tests and independent 109 tests passed, including unchanged source SQLite after mid-copy abort. The callback is after each SQLite chunk; it cannot prevent unrelated processes consuming disk between checks, so actual headroom remains operationally necessary.

After the recovery deployment created a fourth rollback, root reverified 15 DB files plus 15 restore files in each retained R14c1/first-R15b/recovery-R15b snapshot, then deleted the older R14b rollback (13,947 files, 2,832,837,182 bytes; receipt SHA `2a8e0f263d951995f68a15b3a606aae48d9d76073dc7829f5975bd376b651e8b`). Completed R15b scratch QA databases were removed after both agents confirmed closed reads: 23 files, 1,342,742,528 bytes, receipt SHA `06aee1289c0a171e015a3c4f6092539d84f28f71295327646e7f58ab4c86988a`. Non-SQLite evidence and three actual rollback snapshots remain.

The guarded R16a `77cdfb48` fresh rehearsal passed 14 steps/42 ticks/zero escape, binding SHA `96d055a49fc41609ee385b1f62cedae8028d5446e5f07d506a522af4068a9096`. Source full discovery is still running. Its wheel matches 606 files/three embedded JS blocks, SHA `ef5162de71eba3dec7af5d69c1be50982507f8004e3ef9907b7faecf27c51b80`. Host free space remained approximately 6.6 GiB after the copy. R15b recovery observation continues independently; no successor deployment has occurred.


## R15b recovery verified and published

The exact recovery reinstall passed 45/45 samples over 673.874 seconds on controller PID 79169 (started `2026-09-11T23:28:13.378046+00:00`), with fresh heartbeats and all runtime checks healthy. Health SHA `0a9f21902af817dc6e5d32cbfa30420a4050504851f6f5849eeaebca76f9023e`; recovery deployment SHA `aa5086b04f9b2e785f27bca2d721dca1d9c2a8533469bae5e5c59cf99cddb58c`. Post-observation exact-source/configuration verification passed; finalization SHA `404580fb192da522615fc73a8f4b784392bf7581e129627691b40549241f7f25`. Publication receipt SHA `b3efc5cf3e173028038e7a9431237578d08971882e70eb19ab42ff34133593db`; owner current-release/current-runtime-config pointers now identify verified R15b. The first failed observation is preserved and not rewritten.

The successful runtime recovery establishes service/source/configuration acceptance only. Early normal-pipeline audit remains zero fresh outcomes/models while the daily budget waits for UTC reset; a later exact-cutoff read-only audit will separately establish product progress.
