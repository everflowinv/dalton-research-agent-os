...
lane switch (15/16 present). This is a real pre-deploy blocker. After cross-review,
the activation extension refuses before publishing the simulated mission whenever
catalog sync failed; a new run is required after resolving the catalog.
