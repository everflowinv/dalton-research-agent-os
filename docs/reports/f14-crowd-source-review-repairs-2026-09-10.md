...
including `since`, query, handle, or employer slug. A content refusal remains
terminal for the same input, while a changed date or parameter becomes a new
input. Company prefixes keep failures isolated.
