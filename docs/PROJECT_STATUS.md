...
Current checkpoint (2026-09-12 03:16 UTC): R16a `77cdfb486896fafb269e078dd00c07d7df0545ee` is verified and published. Exact runtime606/config17 installation passed 45/45 health samples over 673.488 seconds on controller PID 99648, followed by unchanged source/config verification and publication. Latest three rollback snapshots remain verified; completed R16a rehearsal DBs were removed with evidence retained. R17 `c38eb43800473174aab0673fa5e288c1d6b86545` is frozen and pushed for financial-note authority, period-specific annual EPS, actual model-spec entrypoint wiring and exact product auditing; wheel608/threeJS pass, full suite and guarded copied-state rehearsal running. Independent review fixed a legacy USDPerShare input-hash regression before freeze. Actual five-company prompts fit the 120,000-byte bound; ACN/CTSH/EPAM/IBM have selectable annual note targets but no typed promotions, and DXC lacks exact diluted EPS/share authority. Normal-pipeline product acceptance remains separate: no fresh models/promotions at the early R16a cutoff; post-reset DXC insufficient-evidence completion and EPAM settled output-contract failures require precise reporting rather than blind retries. See [resumed development and next steps](reports/session-resume-r16a-financial-notes-2026-09-12.md).
