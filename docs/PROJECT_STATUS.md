...
Current checkpoint (2026-09-11 11:30 UTC): R11a `424c22529d5317c4c5c9dc8ba88f37299cea3f49` passed the guarded full suite: 7,164 tests / 0 failures / 0 errors / 1 skip in 612.026 seconds. Its wheel SHA is `418bf77f7b5285f9e53e041bdcf9d36463e57a7fa0bd4ce368ded2ec1e50d046`; 572 runtime files and three JavaScript checks pass. Current-state rehearsal v2 passed 68 schemas / 40 entries / 0 escaped, binding all 15 current model configurations and the sole planned service change `backup.keep_latest=3`. Core deployment is still pending review of the concrete stopped-window and recovery commands; live core remains R10a `7e3fb7b`. Alpha metadata selection v3 is now actually activated and healthy: exact 15 configurations, Writer 12653 / Controller 12660 / Control 12664, with web-v6 and the provider bridge preserved. Normal Alpha quota remains in force; activation does not mean missing transcripts have already been acquired. Backup cleanup is complete: original 23 obsolete runtime snapshots deleted (18.45 GiB), then four snapshots superseded by maintenance restarts deleted (3.85 GiB), retaining the newest three with full hash/SQLite integrity checks. Directory is 3.0 GiB; disk has 25 GiB available. Two inactive rehearsal state/home copies were directly deleted (2.18 GiB); logs and acceptance evidence remain. Automatic retention awaits installation of R11a. Beyond the freeze, Dossier gap feedback and secure ticket reads are committed/pushed (`e18054f`, `fa0b59a`); exact targeted annual research admission and configurable bounded model-output repair remain in development. Foundations precede higher investment capabilities, final visual/reference deliverables and multi-workspaces.
