...
Current checkpoint (2026-09-11 23:45 UTC): R15b `5e1d159bf99da02c8e456d07b4d54141b4f32c7c` is verified and published after explicit disk recovery. The fresh reinstall passed exact 606-file/17-config verification and 45/45 same-controller health samples over 673.874 seconds; first failed health and all ENOSPC evidence remain retained. Strict AMZN unit/header presentation and five-company legacy Excel reconstruction/recalculation are accepted; no full statement/Category/Street completeness is implied. Latest three rollback snapshots are retained and individually verified; old backups and completed/failed scratch DBs were removed. R16a `77cdfb486896fafb269e078dd00c07d7df0545ee` combines independently reviewed numeric modelling context with a configurable scratch-space guard; wheel606/threeJS and guarded rehearsal14/42/0 pass, full discovery running. Next: finish exact-source R16a acceptance/deploy/health, verify normal budget-reset research and fresh model production separately, then finish typed financial-note target/evidence/period-specific EPS replay plus production plumbing. Actual originals support four note targets; DXC lacks stored diluted-share authority. Source signatures and human research decisions remain separate. See [R15 recovery and publication](reports/foundation-r15-candidate-acceptance-2026-09-11.md), [numeric context](reports/company-model-source-bound-numeric-context-2026-09-11.md), and [strict AMZN format](reports/fund-amzn-template-parity-review-2026-09-11.md).
