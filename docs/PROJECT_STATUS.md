...
Current checkpoint (2026-09-11 12:49 UTC): R11a `424c225` is deployed_verified: 7,164 tests / 1 skip, exact 572-file wheel, current-state rehearsal v3 and 45 healthy samples over 671.149 seconds with fresh final runtime/config/authority checks. Current release pointer SHA `627be5581943b784b6217769fc9d91b1cde41adff2a57666c78cf66ece0a55d4`; runtime-health acceptance does not imply completed company research. Automatic keep-latest=3 backup retention is live and observed preserving three snapshots after a new deployment snapshot. ZeroBase producer/verifier single-call cost limits were configured to $1 after acceptance; fresh normal-lane results remain pending. Successor code includes ModelSpec repair, Dossier feedback, Event prompt constraints, provider compatibility, exact sales-note/wiki original-text search/read and a source-neutral planner document/version/query strategy. Original documents remain distinct from Claims. Alpha/web/other-filings adapters, verified planner inventory, production targeted-research dispatch and canonical promotion are in parallel development. Foundations precede advanced investment judgement, final visual/reference deliverables and multi-workspaces.
