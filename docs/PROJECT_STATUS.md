...
Current checkpoint (2026-09-12 03:35 UTC): R16a `77cdfb486896fafb269e078dd00c07d7df0545ee` remains verified and published. R17 `c38eb438` passed 7,725 tests / zero failures/errors / one skip, exact wheel608 / threeJS and 14-step / 42-tick / zero-escape copied-state rehearsal; it was superseded before deployment to include independently reviewed corrections. Final R17a `b4bc0a772929900b00a32f79dde29417ab2c40e2` is frozen and pushed. It adds explicit derived-line `concept=null` / `formula.tie_out_concept` prompt authority and proved-paid failure reporting without changing semantic refusal, retry, budget or outcome behavior. All five live-input prompts still fit 120,000 bytes; final wheel and guarded rehearsal pass, fresh full suite is running. Four selectable annual note targets still have no typed promotions; DXC diluted EPS/share evidence remains unavailable. Fresh valid company models are not inferred from successful provider responses. See [resumed development and next steps](reports/session-resume-r16a-financial-notes-2026-09-12.md).
