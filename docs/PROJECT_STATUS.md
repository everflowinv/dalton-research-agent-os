...
Live 仍为 `38721e4`。新恢复候选 `a108f0e` 已冻结：521 个运行文件与 wheel 逐字相同，67 schema / 38 tick entries 的当前状态副本演练通过，全量测试正在运行，尚未部署。详见 [核验恢复验收](reports/verifier-recovery-acceptance-2026-09-10.md)。
