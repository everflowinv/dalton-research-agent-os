...
Current checkpoint (2026-09-11 20:14 UTC): R14b `29aa03d96006a34ca6841e9b98bf77dcb93f38d2` is deployed and published verified: 7,474 tests / zero failures or errors / one skip; 602 exact runtime files; 14-step / 42-tick / zero-escape copied-state rehearsal; 45/45 healthy samples over 670.946 seconds. Seventeen model configs, service bytes, OpenClaw bytes and mission v14 are preserved with zero configuration mutations. The normal coordinator recovered five old Gemini result registrations (50 references, 18 new discovered documents) from existing paid-call receipts without repeating searches. Directed admission now launches, exposing a further company-question scope mismatch: the signed industry mission includes five companies while the legacy backlog accepts only explicitly enumerated Mandate companies. The exact mission-binding repair passed 76 tests and independent review; extraction unreadable/transient handling and conviction prompt/parser/content-retry fixes are also integrated. The R14c full suite found one stale extraction test double among 7,488 tests (zero assertion failures, one error); it was not accepted. The corrected R14c1 freeze `5048af26554dd379a16f4ef5d595dc75d8664b1d` passed 27 focused tests and a fresh 14-step / 42-tick rehearsal; its full suite is running, not deployed. R15 remains in parallel: company-specific income statement DAG, annual diluted-EPS/share authority and immutable annual projections are implemented; the new projection persistence calendar seam is under review. Strict Desktop AMZN export remains **not visually accepted**: root found overlapping period headers, repeated Driver rows and generic Valuation structure in the first rendered candidate; corrections are in progress. Next: accept/deploy R14c1 and observe actual directed reading; close annual authority and render/recalculate AMZN-format export. Human source approvals remain unsigned; current Cockpit style is unchanged. See [R14b acceptance and follow-up](reports/foundation-r14b-runtime-acceptance-2026-09-11.md).
