...
DAILY_BUYBACK_TAPE_OPERATION = "daily_buyback_tape"
...
GOVERNED_OPERATIONS: tuple[str, ...] = (*OPERATIONS, DAILY_BUYBACK_TAPE_OPERATION)
...
HOSTS_BY_OPERATION = MappingProxyType({
    ...
    DAILY_BUYBACK_TAPE_OPERATION: (BUYBACK_REPORT_HOST,),
