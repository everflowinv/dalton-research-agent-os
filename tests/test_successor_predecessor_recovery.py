...
class PredecessorRecoveryTests(unittest.TestCase):
    def setUp(self):
        ...
        deployment = {"status": "deployment_failed", "source_commit": commit,
        ...
        prestart = {"status": "verified_failed_deployment_runtime_safe_to_restart",
        ...
        restart = {"status": "verified_installed_runtime_restarted_healthy",
                   "source_commit": commit, "failed_deployment_sha256": deployment_sha,
                   "prestart_proof_sha256": prestart_sha, "published_owner_release": "R20",
                   "deployment_reclassified": False}
