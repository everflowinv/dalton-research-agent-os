...
class FundXlsxExportTests(unittest.TestCase):
    ...
    def calendar(self):
        value = {"calendar_ref": "fiscal-calendar:acn:2026-09-10",
                 "source_hash": "1" * 64, "as_of": "2026-08-31",
    ...
    def test_fund_layout_and_formula_roles_are_explicit(self):
        ...
        self.assertEqual(sheet.column_dimensions["C"].width, 2.875)
        self.assertEqual(sheet.column_dimensions["D"].width, 24.375)
        self.assertIn("A1:C1", {str(value) for value in sheet.merged_cells.ranges})
